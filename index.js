    ...
    return inquirer.prompt ([
        {
            type: 'input',
            name: 'name',
            message: "Enter the manager's name for this team: ", 
            validate: nameInput => {
                if (nameInput) {
                    return true;
                } else {
...
const writeFile = data => {
    fs.writeFile('./dist/index.html', data, err => {
        ...
        // when the profile has been created 
            ...
            console.log("Your team profile has been successfully created! Check out the index.html in the newly created dist folder.")
        }
    })
}; 
